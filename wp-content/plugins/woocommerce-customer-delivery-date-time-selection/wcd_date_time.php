...
function dateCompare($newdate='',$today=''){
	$date_f = get_date_format();
	if($date_f == 'd-m-Y'){
		$t1 = explode('-',$newdate);
		$t2 = explode('-',$today);
		$days1 = $t1[2] * 365 + $t1[1] * 30 + $t1[0];
		$days2 = $t2[2] * 365 + $t2[1] * 30 + $t2[0];
	}
	else if($date_f == 'm-d-Y'){
		$t1 = explode('-',$newdate);
		$t2 = explode('-',$today);
		$days1 = $t1[2] * 365 + $t1[0] * 30 + $t1[1];
		$days2 = $t2[2] * 365 + $t2[0] * 30 + $t2[1];
	}
	else if($date_f == 'Y-d-m'){
		$t1 = explode('-',$newdate);
		$t2 = explode('-',$today);
		$days1 = $t1[0] * 365 + $t1[2] * 30 + $t1[1];
		$days2 = $t2[0] * 365 + $t2[2] * 30 + $t2[1];
	}
	else if($date_f == 'Y-m-d'){
		$t1 = explode('-',$newdate);
		$t2 = explode('-',$today);
		$days1 = $t1[0] * 365 + $t1[1] * 30 + $t1[2];
		$days2 = $t2[0] * 365 + $t2[1] * 30 + $t2[2];
	}
